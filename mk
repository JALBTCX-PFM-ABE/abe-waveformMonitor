...
if [ $SYS = "Linux" ]; then
    DEFS=NVLinux
    LIBRARIES="-L $PFM_LIB -lCZMIL -lCHARTS -lnvutility -lpfm -lgdal -lxml2 -lpoppler -lGLU"
    export LD_LIBRARY_PATH=$PFM_LIB:$QTDIR/lib:$LD_LIBRARY_PATH
else
    DEFS="WIN32 NVWIN3X"
    LIBRARIES="-L $PFM_LIB -lCZMIL -lCHARTS -lnvutility -lpfm -lgdal -lxml2 -lpoppler -liconv"
